...
The SDK intentionally ships no default redactor. Regex lists and PII shapes drift with provider evolution and your data is yours; a shipped default would be a promise the SDK cannot honour at v0.1.0. The snippet below is an **example, not a shipped class** — adapt it to your threat model:
